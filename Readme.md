<p><strong>v3.1 updates:<br /></strong> </p>
<ul>
  <li>Child width can be alter</li>
  <li>New multiple is introduced. Its multiple but with the checkbox.</li>
  <li><strong>Bonus:</strong> elementname<strong>_mscheck</strong> will be posted along with the form post/get. i.e. if element name is &quot;tech&quot; checkbox <strong>tech_mscheck[]</strong> is created. However you can set the suffix using 'checkboxNameSuffix' parameter.</li>
</ul>
<p><strong>v3.0 updates:<br />
  </strong>
</p>
<ul>
